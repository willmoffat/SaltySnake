...
posix_openpty(PyObject *self, PyObject *noargs)
{
    ...
    /* unlock slave */
        ...
        //}
    PyOS_setsig(SIGCHLD, sig_saved);
    slave_name = NULL; //ptsname(master_fd); /* get name of slave */
    if (slave_name == NULL)
        return posix_error();
    ...
    ioctl(slave_fd, 0, "ptem"); /* push ptem */
    ioctl(slave_fd, 0, "ldterm"); /* push ldterm */
#ifndef __hpux
    ioctl(slave_fd, 0, "ttcompat"); /* push ttcompat */
#endif /* __hpux */
#endif /* HAVE_CYGWIN */
#endif /* HAVE_OPENPTY */
